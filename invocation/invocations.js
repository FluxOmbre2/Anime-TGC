window.addEventListener("load", function () {
    ...
    // Rediriger lorsque le bouton "Choisir" est cliqué
    startButton.addEventListener("click", () => {
        window.location.href = "banniere.html";  // Page de redirection
    });

    // Fonction pour la flèche gauche (redirection vers inventaire.html)
    leftArrow.addEventListener("click", () => {
        window.location.href = "inventaire.html";  // Remplace par la page "inventaire.html"
    });
    ...
    // Redirection vers la page des bannières lorsque le bouton est cliqué
    invokeButton.addEventListener("click", () => {
        window.location.href = "banniere.html";  // Remplace si besoin
    });
});
